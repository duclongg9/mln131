    ...
    <div className="historical-bg-container">
      ...
      >
        <svg viewBox="0 0 200 400" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M100 50C120 70 80 100 100 130C120 160 80 190 100 220C120 250 80 280 100 310" stroke="rgba(255, 215, 0, 0.35)" strokeWidth="6" strokeLinecap="round"/>
          <circle cx="100" cy="50" r="10" fill="rgba(255, 215, 0, 0.4)"/>
        </svg>
      </motion.div>
      ...
      >
        <svg viewBox="0 0 200 400" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M100 50C80 70 120 100 100 130C80 160 120 190 100 220C80 250 120 280 100 310" stroke="rgba(255, 215, 0, 0.35)" strokeWidth="6" strokeLinecap="round"/>
          <circle cx="100" cy="50" r="10" fill="rgba(255, 215, 0, 0.4)"/>
        </svg>
      </motion.div>
      ...
      >
        <svg viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="250" cy="250" r="240" stroke="rgba(212, 175, 55, 0.25)" strokeWidth="2"/>
          {/* Central Star Motif */}
          {[...Array(12)].map((_, i) => (
            <path 
              key={i}
          ...
          <circle cx="250" cy="250" r="40" fill="rgba(212, 175, 55, 0.15)" stroke="rgba(212, 175, 55, 0.3)" strokeWidth="2"/>
        </svg>
      </motion.div>
